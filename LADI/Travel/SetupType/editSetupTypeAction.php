...
$editObject = new SetupType($inData);
...
{
	$resultArray['redirect_url'] = "/Travel/SetupType/editSetupTypeForm.php?id=" . $editObject->getValue('id');
...
$resultArray['success_message'] = "Setup Type Edited";
