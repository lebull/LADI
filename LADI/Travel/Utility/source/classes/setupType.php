 ...
 */
class setupType extends DatabaseObject{
	/**
	 *{@inheritdoc}
	 */
	protected $db_name = "travel_setupType";
	/**
	 *{@inheritdoc}
	 */
...
//--------------Printing--------------//
    ...
    public function translateFancyValues($inKey, $inValue)
	{
		switch($inKey){
				...
				case "id":
					$outValue = "<a href='/Travel/SetupType/editSetupTypeForm.php?id=" . $this->getValue('id') . "' class='button_black' style='width;100%'>" . $inValue . "</a>";
					break;
