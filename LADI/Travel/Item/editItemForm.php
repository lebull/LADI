...
<?php
	...
	if(!isset($_GET['id']) or !$myItem->getByID($_GET['id']))
	{
		die("Id Not Found");
	}
?>
...
<form class="editForm" id="autoSubmit" action="editItemAction.php" method="POST">
<input type="hidden" name="id" id="id" value="<?php echo $myItem->getValue('id');?>"/>

<label for="name">Name</label>
<input type="text" name="name"  id="name" value="<?php echo $myItem->getValue('name');?>"/><br />

<label for="number">Quantity</label>
<input type="text" name="quantity" id="quantity" value="<?php echo $myItem->getValue('quantity');?>"/><br />
